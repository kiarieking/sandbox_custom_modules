        ...
        stage("Setup Environment!!"){
            steps{
                script{
                    ...
                    echo "i'm here!!!!! New setup on server!! Installed python3 venv. Changed requirements.txt path.Changed test directory path.Installed google-chrome and chromedriver.Added .env to test dir.Changed tes_login to test_invalid_login in script."

...
class GeneralDispatchStatementsWizard(models.TransientModel):
    ...
    def get_values(self):
        ...
        return self.env['dispatch.report'].action_generate_report(self, data=data)
...
class GeneralDispatchStatementsReport(models.AbstractModel):
    ...
    def action_generate_report(self, docids, data=None):
        ...
        for dispatch_ledger in dispatch_ledgers:
            ...
            record["description"] = ""
            record['reference'] = dispatch_ledger.name
        ...
        return self.env.ref('quatrix_dispatch_module.dispatch_report_statement').report_action(self, data=docs, config=False)
